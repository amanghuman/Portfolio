...
public class CultivationTreeMenuButtonManager : MonoBehaviour
{
    GameObject player;
    ...
    [SerializeField] private GameObject thisFarmPlot;
    ...
    [SerializeField] private Transform[] farmPlots;
    [SerializeField] private TreeGrowthScript growthScript;

    private WaterGauge waterGauge;
    MeshRenderer farmPlotMeshRenderer;

    GameObject interactCanvas;
    GameObject waterCanEmptyGameobject;
    InteractCanvas interactCanvasScript;

    Button addFertilizerButton, addWaterButton, harvestCropButton;
    [SerializeField] Text addFertilizerText, addWaterText, harvestCropText;
    Animator playerAnim;
    ...
    void Start()
    {
        ...
        waterCanEmptyGameobject = GameObject.Find("UpdateInteractCanvas");
    ...
    public void ActivateButtonMenu(GameObject location)
    {
        ...
        farmPlots = GameObject.Find("TreePlots").GetComponentsInChildren<Transform>();
        ...
        growthScript = thisFarmPlot.GetComponentInChildren<TreeGrowthScript>();
        ...
        farmPlotMeshRenderer = thisFarmPlot.transform.parent.GetComponent<MeshRenderer>();
    ...
    IEnumerator FertilizingCrops()
    {
        ...
        waterCanEmptyGameobject.GetComponent<Canvas>().enabled = true;
        waterCanEmptyGameobject.transform.position = interactCanvas.transform.position;
        ...
        waterCanEmptyGameobject.GetComponent<Canvas>().enabled = false;
    ...
    IEnumerator WateringCrops()
    {
        ...
        if (waterGauge.waterGauge.value > 0)
        {
            ...
            //Debug.Log("Changing Texture to watered");
        ...
        else if (waterGauge.waterGauge.value == 0)
        {
            ...
            waterCanEmptyGameobject.GetComponent<Canvas>().enabled = true;
            waterCanEmptyGameobject.transform.position = interactCanvas.transform.position;
            GameObject.Find("FillingWaterCanvas").GetComponentInChildren<Text>().text = "Watering Can Empty !!!";
    ...
    {
        Text canvasText = GameObject.Find("FillingWaterCanvas").GetComponentInChildren<Text>();
        ...
        //Debug.Log("Changing Texture to dry");
