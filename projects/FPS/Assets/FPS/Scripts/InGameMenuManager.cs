...
public class InGameMenuManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //DebugUtility.HandleErrorIfNullFindObject<DifficultyManager, InGameMenuManager>(m_DifficultyManager, this);
    ...
    {   
        m_DifficultyManager.counter++;
    }

    public void OnDifficultyButtonClickedString()
    {   
        Text txt = GameObject.FindGameObjectWithTag("Difficulty").GetComponent<Text>();
        if(m_DifficultyManager.counter % 2 == 0)
        {
            txt.text = "Easy";
        }
        if(m_DifficultyManager.counter % 2 == 1)
        {
            txt.text = "Hard";
        }
    }
